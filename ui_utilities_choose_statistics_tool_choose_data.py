...
class Ui_Form(object):
    ...
    def confirm_data_choice(self):  # RUS open report creation window
        print("indev")
    ...
    def setupUi(self, Form):
        ...
        self.choosePushButton = QPushButton(Form, clicked=lambda: self.confirm_data_choice())
        self.choosePushButton.setObjectName(u"choosePushButton")
        self.choosePushButton.setGeometry(QRect(30, 530, 91, 31))
        self.closePushButton = QPushButton(Form, clicked=lambda: Form.close())
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle('Выбор данных для статистического анализа')
        ...
        ___qtablewidgetitem2.setText(
            QCoreApplication.translate("Form", u"\u0412\u043b\u0430\u0434\u0435\u043b\u0435\u0446", None));
        ...
        self.label_5.setText(
            QCoreApplication.translate("Form", u"\u041f\u043e\u0441\u0435\u043b\u0435\u043d\u0438\u0435", None))
    # retranslateUi
